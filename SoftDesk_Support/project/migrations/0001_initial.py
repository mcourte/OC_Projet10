# Generated by Django 5.0.3 on 2024-05-21 14:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('project_id', models.UUIDField(help_text='ID of the project to which the issue belongs', verbose_name='project ID')),
